...
**See also: [LESSONS_LEARNED.md](LESSONS_LEARNED.md)** — contains hard-won lessons from building extensions in this repo (build system gotchas, extension architecture patterns, MediaPipe/ML setup, Playwright testing tips). Read it before starting work on a new extension or debugging build/test issues.
