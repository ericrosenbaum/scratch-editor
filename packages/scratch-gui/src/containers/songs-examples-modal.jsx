...
import SongsExamplesModalComponent from '../components/songs-examples-modal/songs-examples-modal.jsx';

const messages = defineMessages({
    loadError: {
        id: 'gui.songsExamplesModal.loadError',
        defaultMessage: 'The example project failed to load.',
        description: 'Error shown when a Songs example project fails to load.'
    }
});

class SongsExamplesModal extends React.PureComponent {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleSelectProject'
...
const mapStateToProps = state => ({
    ...
    visible: state.scratchGui.modals.songsExamplesModal,
    vm: state.scratchGui.vm
});

const mapDispatchToProps = dispatch => ({
    onRequestClose: () => dispatch(closeSongsExamplesModal()),
