...
const MODAL_MUSIC_GENERATION = 'musicGeneration';
...
const openMusicGeneration = function () {
    return openModal(MODAL_MUSIC_GENERATION);
};
const closeMusicGeneration = function () {
    return closeModal(MODAL_MUSIC_GENERATION);
};
export {
    reducer as default,
