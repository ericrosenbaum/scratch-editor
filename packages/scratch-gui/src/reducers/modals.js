...
const MODAL_AUDIO_CLASSIFIER = 'audioClassifierModal';
...
const openAudioClassifierModal = function () {
    return openModal(MODAL_AUDIO_CLASSIFIER);
};
const closeAudioClassifierModal = function () {
    return closeModal(MODAL_AUDIO_CLASSIFIER);
};
export {
    reducer as default,
