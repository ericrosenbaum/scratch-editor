...
const MODAL_STRUCTURE_VIEW = 'structureView';
...
const openStructureView = function () {
    return openModal(MODAL_STRUCTURE_VIEW);
};
...
const closeStructureView = function () {
    return closeModal(MODAL_STRUCTURE_VIEW);
};
export {
    reducer as default,
