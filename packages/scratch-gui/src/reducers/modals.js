...
const MODAL_AI_CODE = 'aiCodeModal';
...
const openAiCodeModal = function () {
    return openModal(MODAL_AI_CODE);
};
const closeAiCodeModal = function () {
    return closeModal(MODAL_AI_CODE);
};
export {
    reducer as default,
