...
const MODAL_TEACHABLE_MACHINE = 'teachableMachineModal';
...
const openTeachableMachineModal = function () {
    return openModal(MODAL_TEACHABLE_MACHINE);
};
const closeTeachableMachineModal = function () {
    return closeModal(MODAL_TEACHABLE_MACHINE);
};
export {
    reducer as default,
