...
- Name: packages/scratch-gui/test/playwright/tips-block-picker.spec.js >> Tips Block Picker >> clicks on the Tips card itself do not exit pick mode
- Location: packages/scratch-gui/test/playwright/tips-block-picker.spec.js:270:5
