...
- Name: packages/scratch-gui/test/playwright/tips-block-picker.spec.js >> Tips Block Picker >> pressing Escape exits pick mode and removes body class
- Location: packages/scratch-gui/test/playwright/tips-block-picker.spec.js:67:5
