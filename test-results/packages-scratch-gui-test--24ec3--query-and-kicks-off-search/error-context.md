...
- Name: packages/scratch-gui/test/playwright/tips-block-picker.spec.js >> Tips Block Picker >> clicking a flyout block sets query and kicks off search
- Location: packages/scratch-gui/test/playwright/tips-block-picker.spec.js:91:5
